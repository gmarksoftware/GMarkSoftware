...
export const Component = () => {
  return (
    <div
      className={cn(
        "relative w-full max-w-5xl mx-auto overflow-hidden rounded-3xl p-8 md:p-12 border border-border-color bg-transparent text-text-primary"
      )}
    >
      {/* Ambient glow */}
      ...
      <div className="relative flex flex-col items-center text-center">
        <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight font-title text-text-primary">
