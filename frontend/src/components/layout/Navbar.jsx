  ...
  return (
    <>
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled
        ...
        <nav className="max-w-[1400px] mx-auto px-6 md:px-8 h-full flex items-center justify-between" aria-label="Main Navigation">
      ...
      <aside className={`fixed top-0 right-0 w-[42%] max-w-[170px] h-screen bg-bg-secondary border-l border-border-color py-32 px-3 z-40 md:hidden flex flex-col justify-between transition-transform duration-300 shadow-2xl ${mobileMenuOpen ? 'translate-x-0' : 'translate-x-full'
        }`}>
