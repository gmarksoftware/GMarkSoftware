...
export default function Navbar({ currentView, onViewChange, activeSection, onActiveSectionChange }) {
  ...
  return (
    <>
      ...
      <aside className={`fixed top-0 right-0 w-[42%] max-w-[170px] h-screen bg-bg-secondary border-l border-transparent py-32 px-3 z-40 md:hidden flex flex-col justify-between transition-transform duration-300 shadow-2xl ${mobileMenuOpen ? 'translate-x-0' : 'translate-x-full'
        }`}>
